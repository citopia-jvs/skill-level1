...
_R1 :_ Créer une app factice comportant les pages suivantes : Accueil, Informations.
...
_R2 :_ Mettre en place un formulaire sur la page Informations comportant les champs suivants : Nom, prénom, date de naissance. L'idée est de répliquer la page "mes informations" d'un utilisateur.
